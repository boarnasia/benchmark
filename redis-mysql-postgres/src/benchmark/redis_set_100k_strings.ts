...
/**
 * Redisに100万件の文字列を追加するベンチマーク
 * @class
 */
export default class RedisSet100kStringsBenchmark extends BaseBenchmark
{
    /** ベンチマークの名前 */
    readonly NAME: string = "Redisに10万件の文字列を追加(set)";
    ...
    override async run(): Promise<BenchmarkResult> {
        ...
        try {
            ...
            // Redis
            // キー名の制限: 基本的なんでも使える(日本語含む), 最大長: 512MB
            // 型: string
            // 型: List
            // 型: Set
            // 型: Sorted Set
